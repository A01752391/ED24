...
void BFS (Graph<char, int> * graph, int u) {
    std::queue<char> Q;
    Q.push (u);
    ...
    while (!Q.empty()) {
        ...
        Vertex<char, int> * current_vertex = graph->search(target);
...
int main(int argc, const char * argv[]) {
    ...
    // Llamar a BFS desde el vértice 'A'
    std::cout << "--- Visualizar multilista con BFS ---" << std::endl;
    BFS(graph, 'A');
